...
class _VendorDashboardPageState extends State<VendorDashboardPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: TranslatableText("Vendor Dashboard"),
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text("Vendor ID: $currentVendorId"),
                Text("User Email: ${FirebaseAuth.instance.currentUser?.email ?? 'Not logged in'}"),
              ],
            ),
          ),
            ...
            child: StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                if (currentVendorId == null) {
                  return Center(child: Text("Vendor ID not found"));
                }
